...
def get_covid19stance_data(train_num_per_class, dev_num_per_class):
    examples = {
        "train" : [],
        "dev": [],
        "test": []
    ...
    examples["train"] = examples["train"][:train_num_per_class]
    ...
    examples["dev"] = examples["dev"][:dev_num_per_class]
...
def get_data(task, train_num_per_class, dev_num_per_class, imbalance_rate,
    ...
    if task in ['covid-19-stance']:
        return get_covid19stance_data(train_num_per_class, dev_num_per_class)
